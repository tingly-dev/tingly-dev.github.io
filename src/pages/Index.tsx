...
const Hero = () => {
    return (
        <section className="pt-28 pb-10 text-center sm:pt-32 md:pt-36 px-3 sm:px-4">
            <h1 className="mx-auto max-w-4xl text-4xl font-semibold tracking-[-0.02em] text-[#111827] sm:text-5xl md:text-7xl">
                Intelligence, Orchestrated.
            </h1>
            <p className="mx-auto mt-5 max-w-2xl text-sm text-[#4B5563] sm:text-base md:text-lg">
                Tingly routes, secures, and accelerates multi-model AI traffic through one precise gateway.
            </p>
